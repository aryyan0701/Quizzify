...
const Api = () => {
  ...
  function answerQuestion(index) {
    const isCorrect =
      apiQuestions[currentQuestionIndex]?.answer.includes(index);
  ...
  const currentQuestion = apiQuestions[currentQuestionIndex];
  ...
  return (
    <div className="container">
      ...
      <div>
        {currentQuestionIndex < apiQuestions.length ? (
          <>
          ...
          <div className="mt-36 text-center">
            ...
            <p className="text-6xl font-bold">
              <span>{correctAnswers}</span> / {apiQuestions.length}
            </p>
            <Link to="/topics">
