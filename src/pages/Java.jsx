...
const Java = () => {
  ...
  function answerQuestion(index) {
    const isCorrect =
      javaQuestions[currentQuestionIndex]?.answer.includes(index);
  ...
  return (
    <div className="container">
      ...
      <div>
        {currentQuestionIndex < javaQuestions.length ? (
          <>
          ...
          <div className="mt-36 text-center">
            ...
            <p className="text-6xl font-bold">
              <span>{correctAnswers}</span> / {javaQuestions.length}
            </p>
            <Link to="/topics">
              <button
                onClick={resetQuiz}
                className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-8 rounded mt-8"
              >
                Reset
              </button>
            </Link>
